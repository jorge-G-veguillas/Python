#=======================================================================
# App: DataBaseSystem for Training Center (v1)
...
class DataBaseSystemTrainingCenter:
    ...
    def addCard(self):
        ...
        sName = input("Name: ")
        iAge = input("Age: ")
        sCourse = input("Course: ")    

        self.DataBaseTraing.append([iID, sName, iAge, sCourse])
    ...
    def updateCard(self):
        ...
        self.DataBaseTraing[iRowCurrent][3] = sCourse
